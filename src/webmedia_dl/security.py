...
DRM_PATTERNS = (
    ...
    re.compile(r"EXT-X-SESSION-KEY:.*METHOD=(?!NONE)", re.I),
    re.compile(r"streamingkeydelivery", re.I),
    re.compile(r"skd://", re.I),
    re.compile(r"urn:mpeg:cenc", re.I),
    re.compile(r"urn:mpeg:dash:mp4protection", re.I),
    re.compile(r"cenc:default_KID", re.I),
    re.compile(r"""(?:schemeIdUri|value)\s*=\s*["']cenc["']""", re.I),
    re.compile(r"""value\s*=\s*["']cbcs["']""", re.I),
    re.compile(r"edef8ba9-79d6-4ace-a3c8-27dcd51d21ed", re.I),
    re.compile(r"9a04f079-9840-4286-ab92-e65be0885f95", re.I),
    re.compile(r"94ce86fb-cfb1-4a2e-967b-0374299925eb", re.I),
