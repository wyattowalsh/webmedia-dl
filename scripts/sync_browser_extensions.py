...
<html lang="en">
  ...
  <body>
    ...
    <p>Paste the token once. Later captures reuse the stored token.</p>
...
POPUP_JS = """import {{ collectFromActiveTab, submitToWorker, activeTabLocator, loadWorkerToken, saveWorkerToken }} from "./capture.js";
