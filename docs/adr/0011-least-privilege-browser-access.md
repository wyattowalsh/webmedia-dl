...
Safari, Chrome, Brave, Edge, Chromium, and Firefox extensions collect page evidence and POST to 127.0.0.1:8765. Host permissions are loopback-only. javascript: URLs are ignored.
