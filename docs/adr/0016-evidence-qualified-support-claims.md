...
Doctor and validation use PASS/WARN/BLOCKED/FAIL. Planned or simulated checks never become PASS. Apple devices, stores, signing, notarization, App Review, and legal review stay BLOCKED until executed.
