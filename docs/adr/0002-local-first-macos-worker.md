---
title: "macOS hosts the full local worker"
status: accepted
date: 2026-08-18
change: build-webmedia-dl-v1
---
# ADR 0002: macOS hosts the full local worker
...
macOS hosts the authenticated loopback worker. iPhone, iPad, and visionOS are complete clients with lightweight local transfer and paired-Mac heavy work. watchOS and tvOS are capture/status/history/controls, not subprocess workers.
