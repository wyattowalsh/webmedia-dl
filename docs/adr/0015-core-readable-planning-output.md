...
OpenSpec, ADRs, JSON Schema, and planning notes stay in git as readable text. Overlay files reconstructed from the 2026-08-18 pack inventory are labeled when original bytes were unavailable.
