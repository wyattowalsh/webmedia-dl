---
title: "Only publication writes user-visible paths"
status: accepted
date: 2026-08-18
change: build-webmedia-dl-v1
---
# ADR 0009: Only publication writes user-visible paths
...
Publication writes under a user-approved root via a temporary directory and atomic replace. Photos/Files/Share require Apple hardware and approved roots.
