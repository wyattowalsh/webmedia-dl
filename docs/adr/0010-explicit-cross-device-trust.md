...
Pairing uses an expiring nonce, Mac-side confirmation, a session key, and an authenticated encrypted envelope. Transport does not decide capability policy.
