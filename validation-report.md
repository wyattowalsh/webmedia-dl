...
|---|---|---|
| `uv run pytest` | PASS | 582 tests locally; GitHub Actions `ci` run `32565480088` (`7088fda`) passed Python and failed Swift 6 iOS `status` mutation from a nonisolated WatchConnectivity callback; `32565220846` (`8cc0172`) passed Python (580 pytest) and failed Swift 6 non-Sendable `displayedResponse` closures; GitHub `32564115037` (`7b909d0`) was 580 pytest at 99% with Swift 18/0 and 12× BUILD SUCCEEDED |
| `uv run pytest --cov` | PASS | 582 tests at 100% locally (`fail_under` 99); GitHub `32565480088` (`7088fda`) Python job was 582 tests at 100%; GitHub `7b909d0` was 99% before the yt-dlp quarantine branch tests |
