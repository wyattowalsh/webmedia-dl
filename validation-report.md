...
|---|---|---|
| `uv run pytest` | PASS | 298 tests |
| `uv run pytest --cov` | PASS | 91.99% (`fail_under` 85) |
...
| CLI paste/speak/drop fail-closed | PASS | DRM locators exit 1 with `job.error`; missing drop files fail closed without a job |
